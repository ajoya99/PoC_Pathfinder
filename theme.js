...
const TRANSLATIONS = {
  en: {
    ...
    "planner.summaryReady": "Route ready with {algorithm}. Goal: {mode}. Zone: {zone}. Traffic: {traffic}.",
  ...
  nl: {
    ...
    "planner.summaryReady": "Route klaar met {algorithm}. Doel: {mode}. Zone: {zone}. Drukte: {traffic}.",
