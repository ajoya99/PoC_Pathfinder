...
const TRANSLATIONS = {
  en: {
    ...
    "planner.modeProductPending": "Product tab is ready. Content coming next.",
    "planner.productName": "Product name",
    "planner.productNamePlaceholder": "-- Select a product --",
    "product.shower-stool": "Shower stool",
    "product.wheelchair": "Wheelchair",
    "product.commode-chair": "Commode chair",
    "product.back-support": "Back support",
    "product.bed-reading-table": "Bed reading table",
    "product.height-adjustable-bed": "Height-adjustable bed",
    "product.standard-mattress": "Standard mattress",
    "product.bedpan": "Bedpan",
    "product.shower-chair": "Shower chair",
    "product.toilet-raiser-10cm": "Toilet raiser 10 cm",
    "status.productRequired": "Select a product first.",
    "status.productNotFound": "No location defined for this product in the current layout.",
    "status.productUnreachable": "Could not find a reachable cell for this product.",
    "status.productRouteBuilt": "Best route to {product} generated.",
    "status.productReset": "Product window reset.",
  ...
  nl: {
    ...
    "planner.modeProductPending": "Product-tab staat klaar. Inhoud volgt hierna.",
    "planner.productName": "Productnaam",
    "planner.productNamePlaceholder": "-- Selecteer een product --",
    "product.shower-stool": "Douchekruk",
    "product.wheelchair": "Rolstoel",
    "product.commode-chair": "Toiletstoel",
    "product.back-support": "Rugondersteuning",
    "product.bed-reading-table": "Bedtafel",
    "product.height-adjustable-bed": "Hoog-laagbed",
    "product.standard-mattress": "Standaardmatras",
    "product.bedpan": "Ondersteek",
    "product.shower-chair": "Douchestoel",
    "product.toilet-raiser-10cm": "Toiletverhoger 10 cm",
    "status.productRequired": "Selecteer eerst een product.",
    "status.productNotFound": "Geen locatie gedefinieerd voor dit product in de huidige layout.",
    "status.productUnreachable": "Geen bereikbare cel gevonden voor dit product.",
    "status.productRouteBuilt": "Beste route naar {product} gegenereerd.",
    "status.productReset": "Productvenster gereset.",
